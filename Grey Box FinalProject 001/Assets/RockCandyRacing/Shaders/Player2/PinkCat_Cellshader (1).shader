...
Shader "Shader Forge/PinkCat_Cellshader" {
    Properties {
        ...
        _node_4732 ("node_4732", Color) = (0.3970588,0,0.1725152,1)
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
