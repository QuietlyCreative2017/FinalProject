...
Shader "Shader Forge/SpeedBoostShader" {
    Properties {
        ...
        _Background_Opacity ("Background_Opacity", Range(0, 1)) = 1
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform float _Background_Opacity;
...
////// Emissive:
                ...
                float node_7269 = lerp((lerp(node_7932.a,node_4885.a,node_4885.a)*_windSmall_Opacity),node_1102,node_1102); // Alpha lerp
                float3 emissive = lerp(lerp(lerp((node_7932.rgb*_Small_OutlineColor.rgb),(node_4885.rgb*_Small_FillColor.rgb),node_4885.a),lerp((node_8893.r*_Large_OutlineColor.rgb),(node_2844.rgb*_Large_FillColor.rgb),node_2844.a),node_1102),_Background_Colour.rgb,(1.0 - node_7269));
                float3 finalColor = emissive;
                fixed4 finalRGBA = fixed4(finalColor,lerp(_Background_Opacity,node_7269,node_7269));
