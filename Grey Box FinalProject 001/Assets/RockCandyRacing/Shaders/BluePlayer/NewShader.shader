    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_7078 = 0.025;
                o.pos = UnityObjectToClipPos( float4(v.vertex.xyz + v.normal*node_7078,1) );
