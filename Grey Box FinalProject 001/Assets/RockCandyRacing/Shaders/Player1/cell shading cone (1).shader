    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.pos = UnityObjectToClipPos( float4(v.vertex.xyz + v.normal*(0.05/75.0),1) );
